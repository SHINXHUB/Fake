...
function Notif.New(text, timee)
    ...
    image_button.Image = "rbxassetid://16223659141"
...
local Library = Update:Window("Gamer144 Hub","",Enum.KeyCode.RightControl);
                        ...
                        elseif World1 then
                            if game:GetService("Workspace").Enemies:FindFirstChild("Galley Captain") then
                                if game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") then
                                    ...
                                    until _G.AutoObservation == false or not game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild(".Label")
                                else
                                    repeat task.wait()
